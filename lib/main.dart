      ...
      child: Scaffold(
        ...
        body: BlocConsumer<CounterBloc, CounterState>(
          ...
          builder: (context, state){
            final invaludValue = (state is CounterStateInvalidNumber)? state.invalidValue : '';
          return Column(
            children: [Text('Current value => ${state.value}'),
            Visibility(
              child: Text('Invalid input: $invaludValue'),
...
class CounterStateInvalidNumber extends CounterState {
  ...
  const CounterStateInvalidNumber({
    ...
    required int previousValue,}) : super(previousValue);
}
