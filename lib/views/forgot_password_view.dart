       ...
       if(state is AuthStateForgotPassword){
        ...
        if(state.exception != null){
          await showErrorDialog(
            context, 'We could not process your request. Please make sure that you are a registered user');
        }
       }
    },
    child: Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            const Text('We could not process your request. Please make sure that you are a registered user'),
            TextField(
